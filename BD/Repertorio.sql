...
G.Origen,
G.Genero,
DATE_FORMAT(G.Inicio, "%d / %M / %Y") AS FechaInicio,
DATE_FORMAT(G.Fin, "%d / %M / %Y") AS FechaFin,
...
a.Origen,
a.Genero,
DATE_FORMAT(a.Inicio, "%d / %M / %Y") AS FechaInicio,
DATE_FORMAT(a.Fin, "%d / %M / %Y") AS FechaFin,
...
b.Origen,
b.Genero,
DATE_FORMAT(b.Inicio, "%d / %M / %Y") AS FechaInicio,
DATE_FORMAT(b.Fin, "%d / %M / %Y") AS FechaFin,
