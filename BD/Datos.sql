...
(NULL, 'Batería', 'La batería es un conjunto de instrumentos musicales de percusión usado por muchas agrupaciones musicales.', 'https://www.pngarts.com/files/3/Yamaha-Drum-Transparent-Images.png'),
...
(NULL, 'Kurt Donald Cobain', 'Kurt Cobain', 'H', '1967-02-20', '1994-04-05', 1.75, 5, 'Voz, Guitarra', 'Barítono ligero', 'https://pbs.twimg.com/media/Dz26hESUYAAtf9C?format=jpg&name=4096x4096'),
(NULL, 'David Eric Grohl', 'Dave Grohl', 'H', '1969-01-14', NULL, 1.83, 5, 'Voz, Batería, Guitarra, Bajo eléctrico, Piano, Sintetizador', 'Tenor ligero', 'https://fondosmil.com/fondo/104285.jpg'),
(NULL, 'Billie Joe Armstrong', 'Billie Joe Armstrong', 'H', '1972-02-17', NULL, 1.7, 5, 'Voz, guitarra, bajo, piano, mandolina, batería, armónica','Tenor', 'https://greendaylover.files.wordpress.com/2009/10/vma05_greendaybillyjoe.jpg'),
(NULL, 'Chester Charles Bennington', 'Chester Bennington', 'H', '1973-03-20', '2017-07-20', 1.78, 5, 'Voz, guitarra, instrumento de percusión y piano', 'Tenor ligero, Gutural', 'https://www.teahub.io/photos/full/77-776215_chester-bennington.jpg');
